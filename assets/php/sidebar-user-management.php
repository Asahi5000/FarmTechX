...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-content">
        ...
        <nav class="nsidebar-menu">
            <a href="../pages/admin-dashboard.php" class="nav-item">
                <i class='bx bx-leaf'></i>
                <span>Dashboard</span>
            </a>
            <a href="../pages/admin-user-management.php" class="nav-item active dashboard ">
                <i class='bx bxs-user-detail' style="color: black;" ></i>
            ...
            <a href="../pages/admin-about.php" class="nav-item">
